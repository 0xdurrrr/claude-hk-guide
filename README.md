...
- **本指南以 [OpenHK](https://openhk.net/) 為例：** 它面向港澳用戶訪問 AI 工具，並內置「SMS 驗證」功能可直接取得美國號碼，省去另找接碼平台的工夫。
...
1. 登入該 VPN 服務網站的 dashboard，點擊下方的「SMS 驗證」。
2. 服務列表中選擇「Claude AI」，付款後你將得到一個美國號碼。
3. 將取得的號碼填入 Claude 註冊頁面，點擊「Send Code」。
4. 回到「SMS 驗證」頁面查看收到的驗證碼，填入 Claude 完成驗證。
...
1. 下載 **Avalanche** App，完成 KYC，獲取 Visa 虛擬卡。
2. 下載 **Kraken** App，完成 KYC，以本地信用卡或 Apple Pay 購買 USDC。
3. 將 USDC 轉帳至 Avalanche Card 地址，為虛擬卡充值。
4. 將虛擬卡加入 Apple Pay / Google Pay，在 [claude.ai](https://claude.ai) 付款。
...
4. 購買美國 Apple Gift Card（可在 [Apple 美國官網](https://www.apple.com/us/shop/gift-cards)、Amazon.com 或禮品卡代購平台購買），在 App Store 點擊頭像 →「Redeem Gift Card or Code」完成充值。
...
- **VPN 安全：** 選擇信譽良好的 VPN 服務商，避免使用已被 AI 平台標記的公共 VPN。

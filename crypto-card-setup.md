...
> **適用對象：** 沒有海外信用卡，但希望在 <a href="https://claude.ai" target="_blank" rel="noopener noreferrer">claude.ai</a> 官網直接付款訂閱的香港及澳門用戶。
...
1. 在 App Store 或 Google Play 搜尋「**<a href="https://www.avalanchecard.com/" target="_blank" rel="noopener noreferrer">Avalanche Card</a>**」並下載安裝。
2. 開啟 App，使用電郵註冊帳號。
3. 按指引完成 **KYC 身份驗證**：
...
1. 在 App Store 或 Google Play 搜尋「**<a href="https://www.kraken.com/zh-hant/features/cryptocurrency-apps" target="_blank" rel="noopener noreferrer">Kraken</a>**」並下載安裝。
2. 註冊帳號並登入。
...
2. 在手機瀏覽器（iPhone 用 Safari、Android 用 Chrome）打開 <a href="https://claude.ai" target="_blank" rel="noopener noreferrer">claude.ai</a>，選擇訂閱計劃。
